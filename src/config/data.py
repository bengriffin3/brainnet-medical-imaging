...
Original file is located at
    https://colab.research.google.com/drive/1qcCShBWhf7Z3EsqNY862Wk1nEvRhLJcF
"""
...
def data_setup_remove_duplicated(vision_transformer=False):
    # Download dataset (must be assigned or it won't persist)
    dataset_path = kagglehub.dataset_download("masoudnickparvar/brain-tumor-mri-dataset")
    print(f"Dataset path: {dataset_path}")
    find_and_remove_duplicate_images(dataset_path)
    # Create a directory for unique files
    new_path = '/tmp/unique_files/'
    os.makedirs(new_path, exist_ok=True)
    print(os.makedirs(new_path, exist_ok=True))
    label_conversion_dict = {
        'glioma': 0,
        'meningioma': 1,
        'notumor': 2,
