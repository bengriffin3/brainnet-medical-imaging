...
Original file is located at
    https://colab.research.google.com/drive/1lS-KbyiX11d5LYihkcLMCRIeT5mRVAtc
"""
...
# Define the BrainTumorCNN with topological features
class BrainTumorCNN_Topo(nn.Module):
    """CNN architecture for brain tumor classification with topological features.

    Architecture:
        - 4 convolutional layers with LeakyReLU activation and max pooling
        - Concatenate with persistent image
        - 2 fully connected layers
        - Input shape: (batch_size, 1, 128, 128, 25) for 25 topological features
        - Output shape: (batch_size, 4) for 4 tumor classes
    """
    def __init__(self):
        super(BrainTumorCNN_Topo, self).__init__()
